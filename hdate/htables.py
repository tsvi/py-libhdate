...
ZMANIM = (
    ...
    ZMAN("end_shma_mga", LANG(u"Shema EOT MG\"A", u"סוף זמן ק\"ש מג\"א")),
    ZMAN("end_shma_gra", LANG(u"Shema EOT GR\"A", u"סוף זמן ק\"ש הגר\"א")),
    ZMAN("end_tfila_mga", LANG(u"Tefila EOT MG\"A", u"סוף זמן תפילה מג\"א")),
    ZMAN("end_tfila_gra", LANG(u"Tefila EOT GR\"A", u"סוף זמן תפילה גר\"א")),
    ZMAN("midday", LANG(u"Midday", u"חצות היום")),
    ZMAN("mincha_gedola", LANG(u"Big Mincha", u"מנחה גדולה")),
    ZMAN("mincha_ketana", LANG(u"Small Mincha", u"מנחה קטנה")),
